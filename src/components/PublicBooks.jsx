...
// useReducer – folosit pentru gestionarea datelor API
//  Reducerul controlează trei stări logice:
//     FETCH_START → pornește încărcarea
//     FETCH_SUCCESS → primește datele și oprește încărcarea
//     FETCH_ERROR → oprește încărcarea și salvează eroarea
...
//    setQuery → funcția care actualizează valoarea la fiecare tastare
//    useState - declanșează reafisarea automata când se schimbă query (se schimba starea).
  ...
  // useEffect rulează de fiecare dată când se schimbă query.
  //  declanșează cererea API doar dacă inputul nu e gol.
  //  folosește dispatch pentru a trimite acțiuni către reducer.
